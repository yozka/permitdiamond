...
///--------------------------------------------------------------------------------------
 ...
 ///=====================================================================================
///
/// возратить токен доступа (пароль сервера)
/// 
/// 
///--------------------------------------------------------------------------------------
String AOptions ::token()const
{
	TData data;
	read(data);
	return (char*)data.token;
}
///--------------------------------------------------------------------------------------
...
/// 
///--------------------------------------------------------------------------------------
void AOptions ::setToken(const String &token)
{
	TData data;
	read(data);
	token.getBytes(data.token, sizeof(TData::token));
	write(data);
}
///--------------------------------------------------------------------------------------
